Python program to generate a random password which takes input as length of the password and print a random password which may consist of capital and lower alphabets, numbers and symbols.
